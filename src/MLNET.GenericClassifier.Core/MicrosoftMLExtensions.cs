...
public static class MicrosoftMLExtensions
{
    public static IDataView ToDataView<TRow>(this IEnumerable<TRow> list, MLContext mlContext) where TRow : class
        => mlContext.Data.LoadFromEnumerable(list);
